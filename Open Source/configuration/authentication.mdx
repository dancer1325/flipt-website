...
* Flipt [v1.39.0+](https://github.com/flipt-io/flipt/releases/tag/v1.39.0)
* == 👁️ -- restrict access to a set of -- GitHub teams 👁️
  * 👁️ GitHub teams -- must exist in the -- `github.allowed_organizations` 👁️
* `github.allowed_teams=TeamsToEnableIt`
* _Example:_
